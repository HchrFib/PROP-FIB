...
/** @file VistaAnadirItem.java
 @brief Implementación de la vista que representa la funcionalidad de añadir items
 */

/** @class VistaAnadirItem

Esta vista permite al usuario interactuar con el sistema para añadir items nuevos.
 */
public class VistaAnadirItem {

    private CtrlPresentacio ctrl_presentacio;
    private JFrame frameVista = new JFrame("Añadir Item");
    private JPanel mainPanel = new JPanel();
    private JPanel northPanel = new JPanel();
    private JPanel southPanel = new JPanel();
    private JPanel centerPanel = new JPanel();
    private JLabel title = new JLabel("Introduzca el ID del nuevo item que quiere añadir:");
    ...
    public VistaAnadirItem(){}

    /** @brief Creadora con paso de parámetros.

    Crea la instancia de la clase VistaAnadirItem.
    \pre <em>Cierto</em>
     ...
     */
    public VistaAnadirItem(CtrlPresentacio ctrlPresentacio) {
    ...
    private void setActionsListeners() {
        submit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (!(isNumeric(itemId))) {
                    ...
                    if (!existeUsuario) {
                        ctrl_presentacio.itemNuevo(itemValue);
                    }
                    else {
                        JOptionPane.showMessageDialog(null,"Ya existe un item con este ID", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
        ...
        cancel.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (answer == 0)  {  // yes
                    ctrl_presentacio.anadirItemCancelado();
                }
            }
        });
