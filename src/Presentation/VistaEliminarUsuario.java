...
/** @file VistaEliminarUsuario.java
 @brief Implementación de la vista que representa la funcionalidad de eliminar usuarios
 */
/** @class VistaEliminarUsuario

Esta vista permite al usuario interactuar con el sistema para eliminar usuarios existentes.
 */
public class VistaEliminarUsuario {

    private CtrlPresentacio ctrl_presentacio;
    private JFrame frameVista = new JFrame("Eliminar Usuario");
    private JPanel mainPanel = new JPanel();
    private JPanel northPanel = new JPanel();
    private JPanel southPanel = new JPanel();
    private JPanel centerPanel = new JPanel();
    private JLabel title = new JLabel("Introduzca el ID del usuario que quiere eliminar:");
     ...
     */
    public VistaEliminarUsuario(CtrlPresentacio ctrlPresentacio) {
    ...
    private void setActionsListeners() {
        submit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (!(isNumeric(userId))) {
                    ...
                    if (existeUsuario) {
                        int answer = JOptionPane.showConfirmDialog(null,"¿Está seguro de que quiere eliminar el usuario " + userId +
                                "? \n Se eliminarán también todas sus valoraciones.", "Question", JOptionPane.YES_NO_OPTION);

                        if (answer == 0) ctrl_presentacio.usuarioEliminado(userValue);
                    }
                    else {
                        JOptionPane.showMessageDialog(null,"No existe un usuario con este ID", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
        ...
        cancel.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (answer == 0)  {  // yes
                    ctrl_presentacio.eliminarUsuarioCancelado();
                }
            }
        });
