...
/** @file VistaDefinirItemNuevo.java
 @brief Implementación de la vista que nos permite concretar qué valores tendrá en cada atributo
  el ítem nuevo que estamos definiendo.
 */

/** @class VistaDefinirItemNuevo

Esta vista permite al usuario definir los valores de los distintos atributos del ítem que estamos añadiendo.
 */
public class VistaDefinirItemNuevo {
    ...
    // FRAME
    private JFrame frameVista = new JFrame("Definir Item Nuevo");
    ...
    // LABELS
    private JLabel title = new JLabel("Aquí puede definir los atributos del ítem nuevo:");
    private JLabel itemIdlabel = new JLabel("itemId: ");
    private JLabel itemIdSeleccionado = new JLabel("null");

    // BUTTONS
    private JButton submit = new JButton("Guardar Item Nuevo");
    ...
    public VistaDefinirItemNuevo() {
    }

    /** @brief Creadora con paso de parámetros.

    Crea la instancia de la clase VistaDefinirItemNuevo.
    \pre <em>Cierto</em>
     ...
     */
    public VistaDefinirItemNuevo(CtrlPresentacio ctrlPresentacio) {
    ...
    private void setActionsListeners() {
        submit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (todoCorrecto) {
                    ...
                    ctrl_presentacio.guardarItemNuevo(resultat);
                    ctrl_presentacio.itemNuevoDefinido();
                }
            }
        });
        ...
        cancel.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (answer == 0)  {  // yes
                    ctrl_presentacio.definirItemNuevoCancelado();
                }
            }
        });
        ...
        frameVista.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                int answer = JOptionPane.showConfirmDialog(null,"Si cierra la ventana no se guardará el ítem nuevo. \n" +
    ...
    \pre <em>Cierto</em>
    \post Llena la tabla del scroll panel con las nombres y tipos de los atributos que componen al ítem que estamos definiendo.
     */
    public void definirItemNuevo(int itemId, HashMap<String, String> cabecera_y_tipos) {
